...
function ProductDetail() {
  ...
  const allPageProducts = productData
      ...
      <nav aria-label="breadcrumb" className="bg-custom-light rounded mb-4">
        <ol className="breadcrumb p-3">
          <li className="breadcrumb-item">
            <a className="text-decoration-none link-secondary" href="/products">
              All Products
            </a>
          </li>
          <li className="breadcrumb-item">
      ...
      <div className="row">
        <div className="col-md-12 mb-4">
          ...
          <div className="row row-cols-1 row-cols-md-3 row-cols-lg-4 g-3">
            {allPageProducts.filter(d => d.id !== product.code).map(d => {
              return (
                <FeatureProduct key={d} product={d} percentOff={d % 2 === 0 ? 15 : null} />
              );
            })}
          </div>
        </div>
